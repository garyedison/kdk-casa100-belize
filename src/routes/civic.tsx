    ...
    <AppShell>
      <div className="mx-auto max-w-[1400px] px-4 py-8 md:px-6">
        <p className="text-[11px] uppercase tracking-[0.16em] text-muted">
          Civic extras · in the Full village all-in
        </p>
        <h1 className="font-display text-3xl font-semibold tracking-tight md:text-4xl">
          Plaza, pavilion, and gatehouse
        </h1>
        <p className="mt-2 max-w-3xl text-ink-soft">
          These drawings are conceptual — a government-budget civic green, not a resort. The dollars
          are already in the Full village all-in ({usd(CIVIC_TOTAL)} EST. for civic extras). Hide the
          Civic extras package on{" "}
          <Link to="/scopes" className="text-kdk underline-offset-4 hover:underline">
            Scopes
          </Link>{" "}
          if the Government does not want the plaza.
        </p>
        ...
        <section className="mt-10">
          ...
          <p className="mt-1 text-sm text-ink-soft">
            Civic extras total {usd(CIVIC_TOTAL)} EST. — already inside Full village. Off on Homes
            only, Landed Belize, Pads, and Village utilities (no plaza).
          </p>
